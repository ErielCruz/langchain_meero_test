This app is using `gpt-3.5-turbo` OpenAI LLM model to answer questions or summarize information from the User Research Sessions. This is a preview app with a limited budget.
